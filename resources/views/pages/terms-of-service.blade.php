<x-layout>
    <div class="relative min-h-screen bg-white pt-10">
        <div class="absolute inset-0 pointer-events-none">
            ...
            <div class="absolute top-1/2 -right-40 w-[38rem] h-[38rem] rounded-full bg-[#056360]/5 blur-3xl"></div>
        </div>
        ...
        <header class="relative">
            <div class="max-w-7xl mx-auto px-6 pt-28 pb-14">
                <div class="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8">
                    ...
                    <div>
                        <x-layouts.button href="{{ url('landing-page') }}" type="outline" color="tiffany-blue" size="md" text="Back to Home" />
                    </div>
                </div>
            </div>
        </header>
